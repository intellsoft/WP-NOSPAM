...
<table class="wp-list-table widefat">
    ...
    <tbody>
    <tr>
    	<td colspan="2"><strong>This plugin should work with default settings, however if you begin to get spam, update the field name below.</strong><br />
        <em>The field name now changes automatically every day.</em></td>
    </tr>	
