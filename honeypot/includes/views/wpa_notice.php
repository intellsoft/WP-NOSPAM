    ...
    if(is_plugin_active( 'wp-armour-extended/wp-armour-extended.php' ) ) {
        if ($GLOBALS['wpae_version'] < 1.17 ){
            echo '<div class="notice notice-error is-dismissible">
                <p><strong style="color:#900;">IMPORTANT : </strong> Your are using older version of NO SPAM Extended. Please update to 1.17 or above for it to work properly.</p>
            </div>';
        }       
    }
    ...
    if (current_user_can( 'manage_options' )): // ONLY SHOW IF ADMIN
        ...
        if (get_option('wpa_reviews_notice_hide') != 'yes'){
            ...
            if ($installedDays > 30 && $all_spam_blocked > 30){
                echo '<div class="updated success" style="padding:10px; font-size:16px; line-height:1.6;color:#205225;">
                        Hey, NO SPAM has blocked <strong>'.$all_spam_blocked.'</strong> spam submissions till date - that’s awesome! Could you please do us a BIG favor and give it a 5-star rating on WordPress ? Just to help us spread the word and boost our motivation.<br/><br/>
        ...
        if (!is_plugin_active('wp-armour-extended/wp-armour-extended.php')){
            if (get_option('wpa_pateron_notice_hide') != 'yes'){
                ...
                if ($installedDays > 100 && $all_spam_blocked > 300 ){
                    echo '<div class="updated success" style="padding:10px; font-size:16px; line-height:1.6;color:#205225;">
                            Your support is vital for us to keep fighting spam. By supporting us on <a href="https://www.patreon.com/wp_armour" target="_blank">Patreon</a> with as little as USD 1, you will help us continue developing of <strong>NO SPAM</strong> Anti Spam Plugin.
                            <ul style="padding-left:50px;list-style-type: square;">
                                <li><a href="https://www.patreon.com/wp_armour" target="_blank">NO SPAM Patreon Page</a></li>
        ...
        if (get_option('wpa_extended_notice_hide') != 'yes' && !is_plugin_active('wp-armour-extended/wp-armour-extended.php') ){
            ...
            if ($installedDays > 90 && $all_spam_blocked > 1000){
                echo '<div class="updated success" style="padding:10px; font-size:16px; line-height:1.6;color:#205225;">
                        Hey, NO SPAM has blocked <strong>'.$all_spam_blocked.'</strong> spam submissions till date - that’s awesome!<br/><br/>
