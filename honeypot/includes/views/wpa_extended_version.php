...
<div class="why_extended">
    <h3>Extra Tools that NO SPAM Extended offers to make NO SPAM more powerfull.</h3>
    <ul>
        ...
        <li><label>Get HoneyPot Extended Now !</label>
            Get NO SPAM Extended and make NO SPAM more powerful.
            <br/>
        </li>

        <li><label>Don't need NO SPAM Extended Tools ?</label>
            In the long run, spam bots learn how to bypass antispam systems. Staying on top of new methodologies is key. You can motivate us to continue development of the plugin by getting a license for the NO SPAM Extended.
        </li>
